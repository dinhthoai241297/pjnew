...
module.exports.routes = {
    ...
    ***************************************************************************/
    ...
    'POST /admin/user/delete': 'admin.user.delete',
    'POST /admin/user/update': 'admin.user.update',
    'POST /admin/user/getall': 'admin.user.getAll',
    'POST /admin/user/getone': 'admin.user.getOne',
    'POST /admin/user/login': 'admin.user.login',
    'POST /admin/user/logout': 'admin.user.logout',
    'POST /admin/user/updatestatus': 'admin.user.updateStatus',
    'POST /admin/user/checksession': 'admin.user.checkSession',
